...
def evaluate(opt):
    ...
    if opt.ext_disp_to_eval is None:
        ...
        encoder = networks.RefinedEncoderDecoder(num_layers=opt.num_layers, num_features=opt.num_features,
                                                 model_dim=opt.model_dim)

        depth_decoder = networks.BMQL(in_channels=opt.model_dim, patch_size=opt.patch_size,
                                      dim_out=opt.dim_out, embedding_dim=opt.model_dim,
